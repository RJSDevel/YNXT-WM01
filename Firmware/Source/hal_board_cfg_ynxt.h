...
/* Function key */
#define KEY_BV          BV(5)
#define KEY_SEL         P0SEL   
#define KEY_DIR         P0DIR 
#define KEY_INP         P0INP
#define KEY_IEN         P0IEN   
#define KEY_SBIT        P0_5
   
/* Capture 0 channel */   
#define CAPTURE0_BV          BV(2)
#define CAPTURE0_SEL         P0SEL   
#define CAPTURE0_DIR         P0DIR 
#define CAPTURE0_INP         P0INP
#define CAPTURE0_IEN         P0IEN    
#define CAPTURE0_SBIT        P0_2
#define CAPTURE0_IFG         P0IFG
   
/* Capture 1 channel */
#define CAPTURE1_BV          BV(3)
#define CAPTURE1_SEL         P0SEL   
#define CAPTURE1_DIR         P0DIR 
#define CAPTURE1_INP         P0INP
#define CAPTURE1_IEN         P0IEN 
#define CAPTURE1_SBIT        P0_3
#define CAPTURE1_IFG         P0IFG
/* Capture 2 channel */
#define CAPTURE2_BV          BV(4)
#define CAPTURE2_SEL         P0SEL   
#define CAPTURE2_DIR         P0DIR 
#define CAPTURE2_INP         P0INP
#define CAPTURE2_IEN         P0IEN 
#define CAPTURE2_SBIT        P0_4
#define CAPTURE2_IFG         P0IFG
   
#define KEY_POLARITY            ACTIVE_HIGH
#define CAPTURE0_POLARITY       ACTIVE_HIGH
...
extern void zclYnxtWaterMeter_HalKeyInit(void);
...
/* ----------- Push Buttons ---------- */
#define HAL_PUSH_BUTTON1()        (KEY_POLARITY(KEY_SBIT))
#define HAL_PUSH_BUTTON2()        (CAPTURE0_POLARITY(CAPTURE0_SBIT))
#define HAL_PUSH_BUTTON3()        (CAPTURE1_POLARITY(CAPTURE1_SBIT))
#define HAL_PUSH_BUTTON4()        (CAPTURE2_POLARITY(CAPTURE2_SBIT))

#define HAL_PUSH_KEY()                  HAL_PUSH_BUTTON1()
#define HAL_PUSH_CAPTURE0()             HAL_PUSH_BUTTON2()
#define HAL_PUSH_CAPTURE1()             HAL_PUSH_BUTTON3()
#define HAL_PUSH_CAPTURE2()             HAL_PUSH_BUTTON4()
